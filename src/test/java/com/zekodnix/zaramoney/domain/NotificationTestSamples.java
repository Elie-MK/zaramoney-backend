...
public class NotificationTestSamples {
    ...
    public static Notification getNotificationSample1() {
        return new Notification().id(1L).title("title1").message("message1").deepLink("deepLink1");
    }

    public static Notification getNotificationSample2() {
        return new Notification().id(2L).title("title2").message("message2").deepLink("deepLink2");
    }
